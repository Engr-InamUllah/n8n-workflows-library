# 025 ? Lead Scoring and Sales Routing

## Business use case

Automate **Lead Scoring and Sales Routing** to reduce manual handoffs, improve response time, and create a traceable operational record. This blueprint is suitable for a small business or can be extended for a production team.
...
5. **Execute Lead Scoring and Sales Routing** ? perform the primary operation through the relevant n8n app node or an authenticated HTTP Request node.
...
{
  "event_id": "evt_",
  "workflow": "lead-scoring-and-sales-routing",
