# 023 ? Airtable Lead Pipeline Sync

## Business use case

Automate **Airtable Lead Pipeline Sync** to reduce manual handoffs, improve response time, and create a traceable operational record. This blueprint is suitable for a small business or can be extended for a production team.
...
5. **Execute Airtable Lead Pipeline Sync** ? perform the primary operation through the relevant n8n app node or an authenticated HTTP Request node.
...
{
  "event_id": "evt_",
  "workflow": "airtable-lead-pipeline-sync",
