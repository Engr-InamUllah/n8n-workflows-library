# 027 ? HubSpot Deal Follow Up Reminder

## Business use case

Automate **HubSpot Deal Follow Up Reminder** to reduce manual handoffs, improve response time, and create a traceable operational record. This blueprint is suitable for a small business or can be extended for a production team.
...
5. **Execute HubSpot Deal Follow Up Reminder** ? perform the primary operation through the relevant n8n app node or an authenticated HTTP Request node.
...
{
  "event_id": "evt_",
  "workflow": "hubspot-deal-follow-up-reminder",
