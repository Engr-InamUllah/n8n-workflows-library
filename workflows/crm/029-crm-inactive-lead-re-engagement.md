# 029 ? CRM Inactive Lead Re Engagement

## Business use case

Automate **CRM Inactive Lead Re Engagement** to reduce manual handoffs, improve response time, and create a traceable operational record. This blueprint is suitable for a small business or can be extended for a production team.
...
5. **Execute CRM Inactive Lead Re Engagement** ? perform the primary operation through the relevant n8n app node or an authenticated HTTP Request node.
...
{
  "event_id": "evt_",
  "workflow": "crm-inactive-lead-re-engagement",
