# 021 ? HubSpot Lead Enrichment and Assignment

## Business use case

Automate **HubSpot Lead Enrichment and Assignment** to reduce manual handoffs, improve response time, and create a traceable operational record. This blueprint is suitable for a small business or can be extended for a production team.
...
5. **Execute HubSpot Lead Enrichment and Assignment** ? perform the primary operation through the relevant n8n app node or an authenticated HTTP Request node.
...
- A least-privilege n8n credential for HTTP Request, when the selected operation requires authentication
...
{
  "event_id": "evt_",
  "workflow": "hubspot-lead-enrichment-and-assignment",
