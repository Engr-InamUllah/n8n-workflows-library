# 022 ? Salesforce Lead to Slack Alert

## Business use case

Automate **Salesforce Lead to Slack Alert** to reduce manual handoffs, improve response time, and create a traceable operational record. This blueprint is suitable for a small business or can be extended for a production team.
...
5. **Execute Salesforce Lead to Slack Alert** ? perform the primary operation through the relevant n8n app node or an authenticated HTTP Request node.
...
{
  "event_id": "evt_",
  "workflow": "salesforce-lead-to-slack-alert",
