# 049 ? AI FAQ Answer Draft

## Business use case

Use **AI FAQ Answer Draft** to remove repetitive work, shorten cycle time, and produce an auditable result for the owning team.
...
5. **AI FAQ Answer Draft** ? execute the primary action using native n8n nodes or an authenticated HTTP Request.
...
`json
{"event_id":"evt_049","record_id":"REC-1001","email":"user@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"049","destination_id":"DEST-2001","processed_at":"2026-06-18T10:00:04Z"}
`
