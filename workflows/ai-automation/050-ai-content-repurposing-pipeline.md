# 050 ? AI Content Repurposing Pipeline

## Business use case

Use **AI Content Repurposing Pipeline** to remove repetitive work, shorten cycle time, and produce an auditable result for the owning team.
...
1. **Notion page event** ? receive the source event and stamp the execution time.
...
5. **AI Content Repurposing Pipeline** ? execute the primary action using native n8n nodes or an authenticated HTTP Request.
...
- Least-privilege n8n credential for Notion
- Least-privilege n8n credential for Claude
- Least-privilege n8n credential for LinkedIn
- Least-privilege n8n credential for WordPress
...
`json
{"event_id":"evt_050","record_id":"REC-1001","email":"user@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"050","destination_id":"DEST-2001","processed_at":"2026-06-18T10:00:04Z"}
`
