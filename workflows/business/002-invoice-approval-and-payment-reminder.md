# 002 ? Invoice Approval and Payment Reminder

## Business use case

Automate **Invoice Approval and Payment Reminder** to reduce manual handoffs, improve response time, and create a traceable operational record. This blueprint is suitable for a small business or can be extended for a production team.
...
5. **Execute Invoice Approval and Payment Reminder** ? perform the primary operation through the relevant n8n app node or an authenticated HTTP Request node.
...
{
  "event_id": "evt_",
  "workflow": "invoice-approval-and-payment-reminder",
