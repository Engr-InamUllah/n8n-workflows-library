# 009 ? PDF Quote Generation and Delivery

## Business use case

Automate **PDF Quote Generation and Delivery** to reduce manual handoffs, improve response time, and create a traceable operational record. This blueprint is suitable for a small business or can be extended for a production team.
...
5. **Execute PDF Quote Generation and Delivery** ? perform the primary operation through the relevant n8n app node or an authenticated HTTP Request node.
...
- A least-privilege n8n credential for Google Docs, when the selected operation requires authentication
- A least-privilege n8n credential for Google Drive, when the selected operation requires authentication
...
{
  "event_id": "evt_",
  "workflow": "pdf-quote-generation-and-delivery",
