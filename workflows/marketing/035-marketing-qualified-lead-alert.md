# 035 ? Marketing Qualified Lead Alert

## Business use case

Use **Marketing Qualified Lead Alert** to remove repetitive work, shorten cycle time, and produce an auditable result for the owning team.
...
1. **HubSpot property event** ? receive the source event and stamp the execution time.
...
5. **Marketing Qualified Lead Alert** ? execute the primary action using native n8n nodes or an authenticated HTTP Request.
...
`json
{"event_id":"evt_035","record_id":"REC-1001","email":"user@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"035","destination_id":"DEST-2001","processed_at":"2026-06-18T10:00:04Z"}
`
