# 032 ? Campaign Lead Attribution

## Business use case

Use **Campaign Lead Attribution** to remove repetitive work, shorten cycle time, and produce an auditable result for the owning team.
...
5. **Campaign Lead Attribution** ? execute the primary action using native n8n nodes or an authenticated HTTP Request.
...
- Least-privilege n8n credential for Google Analytics
...
`json
{"event_id":"evt_032","record_id":"REC-1001","email":"user@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"032","destination_id":"DEST-2001","processed_at":"2026-06-18T10:00:04Z"}
`
