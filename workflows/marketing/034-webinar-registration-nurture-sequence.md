# 034 ? Webinar Registration Nurture Sequence

## Business use case

Use **Webinar Registration Nurture Sequence** to remove repetitive work, shorten cycle time, and produce an auditable result for the owning team.
...
1. **Webhook** ? receive the source event and stamp the execution time.
...
5. **Webinar Registration Nurture Sequence** ? execute the primary action using native n8n nodes or an authenticated HTTP Request.
...
- Least-privilege n8n credential for Zoom
- Least-privilege n8n credential for HubSpot
- Least-privilege n8n credential for Gmail
...
`json
{"event_id":"evt_034","record_id":"REC-1001","email":"user@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"034","destination_id":"DEST-2001","processed_at":"2026-06-18T10:00:04Z"}
`
