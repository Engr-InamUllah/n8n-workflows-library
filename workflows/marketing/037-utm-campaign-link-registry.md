# 037 ? UTM Campaign Link Registry

## Business use case

Use **UTM Campaign Link Registry** to remove repetitive work, shorten cycle time, and produce an auditable result for the owning team.
...
5. **UTM Campaign Link Registry** ? execute the primary action using native n8n nodes or an authenticated HTTP Request.
...
`json
{"event_id":"evt_037","record_id":"REC-1001","email":"user@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"037","destination_id":"DEST-2001","processed_at":"2026-06-18T10:00:04Z"}
`
