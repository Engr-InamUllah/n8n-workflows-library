# 040 ? Content Calendar Approval

## Business use case

Use **Content Calendar Approval** to remove repetitive work, shorten cycle time, and produce an auditable result for the owning team.
...
Notion database event

## Step-by-step node logic

1. **Notion database event** ? receive the source event and stamp the execution time.
...
5. **Content Calendar Approval** ? execute the primary action using native n8n nodes or an authenticated HTTP Request.
...
- Least-privilege n8n credential for Slack
...
`json
{"event_id":"evt_040","record_id":"REC-1001","email":"user@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"040","destination_id":"DEST-2001","processed_at":"2026-06-18T10:00:04Z"}
`
