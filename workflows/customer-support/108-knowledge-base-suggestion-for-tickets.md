# 108 ? Knowledge Base Suggestion for Tickets

## Business use case

Automate **Knowledge Base Suggestion for Tickets** to shorten response time, reduce repetitive work, and preserve an auditable operational trail.
...
1. **Ticket event** ? receive the event and attach execution metadata.
...
5. **Knowledge Base Suggestion for Tickets** ? execute the core operation through native n8n nodes or an authenticated HTTP Request.
...
`json
{"event_id":"evt_108","record_id":"REC-1001","summary":"Sanitized example","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"108","external_record_id":"DEST-2001","processed_at":"2026-06-18T10:00:03Z"}
`
