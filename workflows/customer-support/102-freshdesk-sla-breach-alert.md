# 102 ? Freshdesk SLA Breach Alert

## Business use case

Automate **Freshdesk SLA Breach Alert** to shorten response time, reduce repetitive work, and preserve an auditable operational trail.
...
5. **Freshdesk SLA Breach Alert** ? execute the core operation through native n8n nodes or an authenticated HTTP Request.
...
- Least-privilege n8n credential for Freshdesk
- Least-privilege n8n credential for Microsoft Teams
...
`json
{"event_id":"evt_102","record_id":"REC-1001","summary":"Sanitized example","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"102","external_record_id":"DEST-2001","processed_at":"2026-06-18T10:00:03Z"}
`
