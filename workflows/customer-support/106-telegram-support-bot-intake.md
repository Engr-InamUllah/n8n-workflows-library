# 106 ? Telegram Support Bot Intake

## Business use case

Automate **Telegram Support Bot Intake** to shorten response time, reduce repetitive work, and preserve an auditable operational trail.
...
1. **Telegram message event** ? receive the event and attach execution metadata.
...
5. **Telegram Support Bot Intake** ? execute the core operation through native n8n nodes or an authenticated HTTP Request.
...
`json
{"event_id":"evt_106","record_id":"REC-1001","summary":"Sanitized example","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"106","external_record_id":"DEST-2001","processed_at":"2026-06-18T10:00:03Z"}
`
