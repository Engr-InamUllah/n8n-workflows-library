# 080 ? Telegram Operations Alert Bot

## Business use case

Automate **Telegram Operations Alert Bot** for a traceable handoff that reduces manual processing and missed follow-up.
...
1. **Error event** ? capture the event and execution metadata.
...
5. **Telegram Operations Alert Bot** ? perform the core operation through a native node or authenticated HTTP Request.
...
`json
{"event_id":"evt_080","source_id":"SRC-1001","actor":"automation@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"080","destination_id":"DEST-2001","duplicate":false}
`
