# 079 ? Teams Meeting Follow Up Tasks

## Business use case

Automate **Teams Meeting Follow Up Tasks** for a traceable handoff that reduces manual processing and missed follow-up.
...
1. **Meeting event** ? capture the event and execution metadata.
...
5. **Teams Meeting Follow Up Tasks** ? perform the core operation through a native node or authenticated HTTP Request.
...
- Least-privilege n8n credential for Planner
...
`json
{"event_id":"evt_079","source_id":"SRC-1001","actor":"automation@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"079","destination_id":"DEST-2001","duplicate":false}
`
