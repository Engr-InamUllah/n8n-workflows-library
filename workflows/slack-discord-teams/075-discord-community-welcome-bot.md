# 075 ? Discord Community Welcome Bot

## Business use case

Automate **Discord Community Welcome Bot** for a traceable handoff that reduces manual processing and missed follow-up.
...
1. **Member event** ? capture the event and execution metadata.
...
5. **Discord Community Welcome Bot** ? perform the core operation through a native node or authenticated HTTP Request.
...
`json
{"event_id":"evt_075","source_id":"SRC-1001","actor":"automation@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"075","destination_id":"DEST-2001","duplicate":false}
`
