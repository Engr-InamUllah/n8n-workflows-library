# 073 ? Microsoft Teams Daily KPI Report

## Business use case

Automate **Microsoft Teams Daily KPI Report** for a traceable handoff that reduces manual processing and missed follow-up.
...
5. **Microsoft Teams Daily KPI Report** ? perform the core operation through a native node or authenticated HTTP Request.
...
`json
{"event_id":"evt_073","source_id":"SRC-1001","actor":"automation@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"073","destination_id":"DEST-2001","duplicate":false}
`
