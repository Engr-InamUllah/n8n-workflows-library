# 078 ? Discord GitHub Release Announcement

## Business use case

Automate **Discord GitHub Release Announcement** for a traceable handoff that reduces manual processing and missed follow-up.
...
1. **Release event** ? capture the event and execution metadata.
...
5. **Discord GitHub Release Announcement** ? perform the core operation through a native node or authenticated HTTP Request.
...
`json
{"event_id":"evt_078","source_id":"SRC-1001","actor":"automation@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"078","destination_id":"DEST-2001","duplicate":false}
`
