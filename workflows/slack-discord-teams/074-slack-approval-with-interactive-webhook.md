# 074 ? Slack Approval with Interactive Webhook

## Business use case

Automate **Slack Approval with Interactive Webhook** for a traceable handoff that reduces manual processing and missed follow-up.
...
1. **Interactive webhook** ? capture the event and execution metadata.
...
5. **Slack Approval with Interactive Webhook** ? perform the core operation through a native node or authenticated HTTP Request.
...
`json
{"event_id":"evt_074","source_id":"SRC-1001","actor":"automation@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"074","destination_id":"DEST-2001","duplicate":false}
`
