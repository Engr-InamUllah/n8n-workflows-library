# 083 ? WordPress Comment Moderation Alert

## Business use case

Automate **WordPress Comment Moderation Alert** for a traceable handoff that reduces manual processing and missed follow-up.
...
1. **Comment event** ? capture the event and execution metadata.
...
5. **WordPress Comment Moderation Alert** ? perform the core operation through a native node or authenticated HTTP Request.
...
`json
{"event_id":"evt_083","source_id":"SRC-1001","actor":"automation@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"083","destination_id":"DEST-2001","duplicate":false}
`
