# 087 ? WooCommerce Product to WordPress Post

## Business use case

Automate **WooCommerce Product to WordPress Post** for a traceable handoff that reduces manual processing and missed follow-up.
...
1. **Product event** ? capture the event and execution metadata.
...
5. **WooCommerce Product to WordPress Post** ? perform the core operation through a native node or authenticated HTTP Request.
...
- Least-privilege n8n credential for WooCommerce
...
`json
{"event_id":"evt_087","source_id":"SRC-1001","actor":"automation@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"087","destination_id":"DEST-2001","duplicate":false}
`
