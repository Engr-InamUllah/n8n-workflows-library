# 082 ? WordPress Post to Social Channels

## Business use case

Automate **WordPress Post to Social Channels** for a traceable handoff that reduces manual processing and missed follow-up.
...
1. **Post published event** ? capture the event and execution metadata.
...
5. **WordPress Post to Social Channels** ? perform the core operation through a native node or authenticated HTTP Request.
...
- Least-privilege n8n credential for Facebook
...
`json
{"event_id":"evt_082","source_id":"SRC-1001","actor":"automation@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"082","destination_id":"DEST-2001","duplicate":false}
`
