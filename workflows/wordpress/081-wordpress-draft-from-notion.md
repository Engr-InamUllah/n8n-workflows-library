# 081 ? WordPress Draft from Notion

## Business use case

Automate **WordPress Draft from Notion** for a traceable handoff that reduces manual processing and missed follow-up.
...
1. **Notion page event** ? capture the event and execution metadata.
...
5. **WordPress Draft from Notion** ? perform the core operation through a native node or authenticated HTTP Request.
...
`json
{"event_id":"evt_081","source_id":"SRC-1001","actor":"automation@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"081","destination_id":"DEST-2001","duplicate":false}
`
