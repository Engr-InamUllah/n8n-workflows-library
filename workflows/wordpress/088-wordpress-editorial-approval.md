# 088 ? WordPress Editorial Approval

## Business use case

Automate **WordPress Editorial Approval** for a traceable handoff that reduces manual processing and missed follow-up.
...
1. **Status change event** ? capture the event and execution metadata.
...
5. **WordPress Editorial Approval** ? perform the core operation through a native node or authenticated HTTP Request.
...
`json
{"event_id":"evt_088","source_id":"SRC-1001","actor":"automation@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"088","destination_id":"DEST-2001","duplicate":false}
`
