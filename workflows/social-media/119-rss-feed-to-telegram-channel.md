# 119 ? RSS Feed to Telegram Channel

## Business use case

Automate **RSS Feed to Telegram Channel** to shorten response time, reduce repetitive work, and preserve an auditable operational trail.
...
1. **Feed event** ? receive the event and attach execution metadata.
...
5. **RSS Feed to Telegram Channel** ? execute the core operation through native n8n nodes or an authenticated HTTP Request.
...
- Least-privilege n8n credential for RSS Feed
- Least-privilege n8n credential for Telegram
...
`json
{"event_id":"evt_119","record_id":"REC-1001","summary":"Sanitized example","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"119","external_record_id":"DEST-2001","processed_at":"2026-06-18T10:00:03Z"}
`
