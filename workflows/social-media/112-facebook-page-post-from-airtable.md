# 112 ? Facebook Page Post from Airtable

## Business use case

Automate **Facebook Page Post from Airtable** to shorten response time, reduce repetitive work, and preserve an auditable operational trail.
...
1. **Airtable record event** ? receive the event and attach execution metadata.
...
5. **Facebook Page Post from Airtable** ? execute the core operation through native n8n nodes or an authenticated HTTP Request.
...
`json
{"event_id":"evt_112","record_id":"REC-1001","summary":"Sanitized example","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"112","external_record_id":"DEST-2001","processed_at":"2026-06-18T10:00:03Z"}
`
