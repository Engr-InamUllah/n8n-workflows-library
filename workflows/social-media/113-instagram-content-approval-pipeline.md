# 113 ? Instagram Content Approval Pipeline

## Business use case

Automate **Instagram Content Approval Pipeline** to shorten response time, reduce repetitive work, and preserve an auditable operational trail.
...
1. **Record event** ? receive the event and attach execution metadata.
...
5. **Instagram Content Approval Pipeline** ? execute the core operation through native n8n nodes or an authenticated HTTP Request.
...
- Least-privilege n8n credential for Instagram
...
`json
{"event_id":"evt_113","record_id":"REC-1001","summary":"Sanitized example","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"113","external_record_id":"DEST-2001","processed_at":"2026-06-18T10:00:03Z"}
`
