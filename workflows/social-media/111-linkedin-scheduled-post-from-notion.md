# 111 ? LinkedIn Scheduled Post from Notion

## Business use case

Automate **LinkedIn Scheduled Post from Notion** to shorten response time, reduce repetitive work, and preserve an auditable operational trail.
...
5. **LinkedIn Scheduled Post from Notion** ? execute the core operation through native n8n nodes or an authenticated HTTP Request.
...
`json
{"event_id":"evt_111","record_id":"REC-1001","summary":"Sanitized example","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"111","external_record_id":"DEST-2001","processed_at":"2026-06-18T10:00:03Z"}
`
