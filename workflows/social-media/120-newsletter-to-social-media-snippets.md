# 120 ? Newsletter to Social Media Snippets

## Business use case

Automate **Newsletter to Social Media Snippets** to shorten response time, reduce repetitive work, and preserve an auditable operational trail.
...
1. **Campaign event** ? receive the event and attach execution metadata.
...
5. **Newsletter to Social Media Snippets** ? execute the core operation through native n8n nodes or an authenticated HTTP Request.
...
- Least-privilege n8n credential for Mailchimp
...
`json
{"event_id":"evt_120","record_id":"REC-1001","summary":"Sanitized example","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"120","external_record_id":"DEST-2001","processed_at":"2026-06-18T10:00:03Z"}
`
