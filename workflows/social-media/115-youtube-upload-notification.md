# 115 ? YouTube Upload Notification

## Business use case

Automate **YouTube Upload Notification** to shorten response time, reduce repetitive work, and preserve an auditable operational trail.
...
1. **Video event** ? receive the event and attach execution metadata.
...
5. **YouTube Upload Notification** ? execute the core operation through native n8n nodes or an authenticated HTTP Request.
...
- Least-privilege n8n credential for YouTube
- Least-privilege n8n credential for Discord
...
`json
{"event_id":"evt_115","record_id":"REC-1001","summary":"Sanitized example","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"115","external_record_id":"DEST-2001","processed_at":"2026-06-18T10:00:03Z"}
`
