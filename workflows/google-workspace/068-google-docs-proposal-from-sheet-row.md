# 068 ? Google Docs Proposal from Sheet Row

## Business use case

Automate **Google Docs Proposal from Sheet Row** for a traceable handoff that reduces manual processing and missed follow-up.
...
1. **Sheet row event** ? capture the event and execution metadata.
...
5. **Google Docs Proposal from Sheet Row** ? perform the core operation through a native node or authenticated HTTP Request.
...
- Least-privilege n8n credential for Google Docs
...
`json
{"event_id":"evt_068","source_id":"SRC-1001","actor":"automation@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"068","destination_id":"DEST-2001","duplicate":false}
`
