# 062 ? Google Sheets Row to Gmail Notification

## Business use case

Automate **Google Sheets Row to Gmail Notification** for a traceable handoff that reduces manual processing and missed follow-up.
...
5. **Google Sheets Row to Gmail Notification** ? perform the core operation through a native node or authenticated HTTP Request.
...
`json
{"event_id":"evt_062","source_id":"SRC-1001","actor":"automation@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"062","destination_id":"DEST-2001","duplicate":false}
`
