# 064 ? Google Calendar Appointment Reminder

## Business use case

Automate **Google Calendar Appointment Reminder** for a traceable handoff that reduces manual processing and missed follow-up.
...
5. **Google Calendar Appointment Reminder** ? perform the core operation through a native node or authenticated HTTP Request.
...
- Least-privilege n8n credential for Google Calendar
- Least-privilege n8n credential for Gmail
- Least-privilege n8n credential for Twilio
...
`json
{"event_id":"evt_064","source_id":"SRC-1001","actor":"automation@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"064","destination_id":"DEST-2001","duplicate":false}
`
