# 070 ? Gmail Daily Digest to Notion

## Business use case

Automate **Gmail Daily Digest to Notion** for a traceable handoff that reduces manual processing and missed follow-up.
...
5. **Gmail Daily Digest to Notion** ? perform the core operation through a native node or authenticated HTTP Request.
...
`json
{"event_id":"evt_070","source_id":"SRC-1001","actor":"automation@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"070","destination_id":"DEST-2001","duplicate":false}
`
