# 091 ? GitHub Issue to Jira Ticket

## Business use case

Automate **GitHub Issue to Jira Ticket** to shorten response time, reduce repetitive work, and preserve an auditable operational trail.
...
1. **Issue event** ? receive the event and attach execution metadata.
...
5. **GitHub Issue to Jira Ticket** ? execute the core operation through native n8n nodes or an authenticated HTTP Request.
...
`json
{"event_id":"evt_091","record_id":"REC-1001","summary":"Sanitized example","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"091","external_record_id":"DEST-2001","processed_at":"2026-06-18T10:00:03Z"}
`
