# 094 ? GitHub Release Notes to Discord

## Business use case

Automate **GitHub Release Notes to Discord** to shorten response time, reduce repetitive work, and preserve an auditable operational trail.
...
1. **Release event** ? receive the event and attach execution metadata.
...
5. **GitHub Release Notes to Discord** ? execute the core operation through native n8n nodes or an authenticated HTTP Request.
...
`json
{"event_id":"evt_094","record_id":"REC-1001","summary":"Sanitized example","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"094","external_record_id":"DEST-2001","processed_at":"2026-06-18T10:00:03Z"}
`
