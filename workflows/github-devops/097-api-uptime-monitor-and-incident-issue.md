# 097 ? API Uptime Monitor and Incident Issue

## Business use case

Automate **API Uptime Monitor and Incident Issue** to shorten response time, reduce repetitive work, and preserve an auditable operational trail.
...
1. **Scheduled** ? receive the event and attach execution metadata.
...
5. **API Uptime Monitor and Incident Issue** ? execute the core operation through native n8n nodes or an authenticated HTTP Request.
...
- Least-privilege n8n credential for HTTP Request
...
`json
{"event_id":"evt_097","record_id":"REC-1001","summary":"Sanitized example","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"097","external_record_id":"DEST-2001","processed_at":"2026-06-18T10:00:03Z"}
`
