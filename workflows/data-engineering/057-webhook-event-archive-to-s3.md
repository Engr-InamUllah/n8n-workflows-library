# 057 ? Webhook Event Archive to S3

## Business use case

Use **Webhook Event Archive to S3** to remove repetitive work, shorten cycle time, and produce an auditable result for the owning team.
...
5. **Webhook Event Archive to S3** ? execute the primary action using native n8n nodes or an authenticated HTTP Request.
...
- Least-privilege n8n credential for Amazon S3
...
`json
{"event_id":"evt_057","record_id":"REC-1001","email":"user@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"057","destination_id":"DEST-2001","processed_at":"2026-06-18T10:00:04Z"}
`
