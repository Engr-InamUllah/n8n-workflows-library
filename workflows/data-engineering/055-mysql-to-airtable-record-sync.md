# 055 ? MySQL to Airtable Record Sync

## Business use case

Use **MySQL to Airtable Record Sync** to remove repetitive work, shorten cycle time, and produce an auditable result for the owning team.
...
5. **MySQL to Airtable Record Sync** ? execute the primary action using native n8n nodes or an authenticated HTTP Request.
...
- Least-privilege n8n credential for MySQL
...
`json
{"event_id":"evt_055","record_id":"REC-1001","email":"user@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"055","destination_id":"DEST-2001","processed_at":"2026-06-18T10:00:04Z"}
`
