# 056 ? Data Quality Threshold Alert

## Business use case

Use **Data Quality Threshold Alert** to remove repetitive work, shorten cycle time, and produce an auditable result for the owning team.
...
5. **Data Quality Threshold Alert** ? execute the primary action using native n8n nodes or an authenticated HTTP Request.
...
`json
{"event_id":"evt_056","record_id":"REC-1001","email":"user@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"056","destination_id":"DEST-2001","processed_at":"2026-06-18T10:00:04Z"}
`
