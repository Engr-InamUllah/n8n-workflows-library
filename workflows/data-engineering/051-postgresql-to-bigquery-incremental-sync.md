# 051 ? PostgreSQL to BigQuery Incremental Sync

## Business use case

Use **PostgreSQL to BigQuery Incremental Sync** to remove repetitive work, shorten cycle time, and produce an auditable result for the owning team.
...
5. **PostgreSQL to BigQuery Incremental Sync** ? execute the primary action using native n8n nodes or an authenticated HTTP Request.
...
- Least-privilege n8n credential for Google BigQuery
...
`json
{"event_id":"evt_051","record_id":"REC-1001","email":"user@example.com","occurred_at":"2026-06-18T10:00:00Z"}
`

## Output example

`json
{"status":"processed","workflow_id":"051","destination_id":"DEST-2001","processed_at":"2026-06-18T10:00:04Z"}
`
